...
#t = open("/Users/sashkins/projects/diploma310/texts/thePerks.txt", "r")
#text = t.read()
t0 = time.time()
...
for tok in doc:
    ...
    #print(f'Text: {tok.text} Part-of-speech: {tok.pos_} Dep: {tok.head}')

print(tokens)
print(len(doc), "количество тэгов")

...
def getPhrasalVerbs():
    pvs = ['brace aback', 'set aback', 'take aback',
            'arse about', 'balls about', 'bandy about', 'bang about', 'bash about', 'bat about', 'be all about',
            'boss about', 'brace about', 'bring about', 'cast about', 'clown about', 'come about', 'cut about',
            'dart about', 'discuss about', 'doss about', 'faff about', 'fall about', 'fart about', 'fiddle about',
            'flail about', 'fool about', 'footle about', 'fuck about', 'get about', 'give about', 'go about', 'go about to',
            'hang about', 'hop about', 'jump about', 'knock about', 'lay about', 'laze about', 'loaf about', 'mess about',
            'mill about', 'mope about', 'move about', 'muck about', 'nose about', 'piss about', 'play about', 'poke about',
            'potter about', 'push about', 'put about', 'put it about', 'put oneself about', 'putter about', 'roll about',
            'root about', 'run about', 'screw about', 'see about', 'set about', 'shift about', 'slob about', 'talk about',
            'think about', 'throw about', 'turn about', 'wheel about', 'punch above', 'raise above', 'come across',
            'come across with', 'cut across', 'get across', 'happen across', 'keep across', 'put across', 'run across',
            'stumble across', 'take across', 'cast adrift', 'run adrift', 'set adrift', '', '', '']

    return ["back down", "blow up", "break down", "bring up", "bump into", "call off", "check on", "check out",
            "check with", "come across", "come back", "come in", "come up with", "cut down", "drop by",
            "drop off", "ease up on", "fall apart", "fall down", "find out", "fight off", "get along", "get away", "get by",
            "get over", "get up", "give away", "give in", "give up", "go ahead", "go on", "go out", "grow up", "hang on",
            "hang out", "kick out", "let in", "look after", "look for", "look up", "make up", "pay back",
            "pick up", "put off", "put on", "put up with", "run out", "take off", "turn on", "turn up",
            "wait up", "watch out", "call back", "count on", "go back", "go over", "answer back", "fall through",
            "go ahead", "let down"]

partsToAvoid = ['aboard', 'absent', 'afore', 'amid', 'among', 'amongst', 'beside', 'besides',
                'but', 'despite', 'according', 'excert', 'inside', 'like', 'next', 'near',
                'opposite', 'outside', 'since', 'than', 'till', 'toward', 'until', ]
# STEP 1: get phrasal verbs and texts
t0 = time.time()
_verbs = getPhrasalVerbs()

# STEP 2: detect potential phrasal verbs
thePerks = """THE PERKS OF BEING A WALLFLOWER
...
I don’t know how news travels around school and why it is very often right. Maybe it was in the lunchroom. It’s hard to remember. But Dave with the awkward glasses told us that Michael killed himself.
...
Vaughn’s office in my middle school and told me to stop crying. Then, he put his arm on my shoulder and told me to get it out of my system before Dad came home. We then went to eat french fries at McDonald’s and he taught me how to play pinball. He even made a joke that because of me he got to skip an afternoon of school and asked me if I wanted to help him work on his

Camaro. I guess I was pretty messy because he never let me work on his Camaro before.
...
My Aunt Helen lived with the family for the last few years of her life because something very bad happened to her. Nobody would tell me what happened then even though I always wanted to know.
...
and after a while my dad had my mom take me to my room. It wasn’t until much later that my mom had a few glasses of white wine and told me what happened to her sister. Some people really do have it a lot worse than I do. They really do.
...
I do not like high school. The cafeteria is called the “Nutrition Center,” which is strange. There is this one girl in my advanced english class named Susan. In middle school, Susan was very fun to be around.
She liked movies, and her brother Frank made her tapes of this great music that she shared with us. But over the summer she had her braces taken off, and she got a little taller and prettier and grew breasts.
Now, she acts a lot dumber in the hallways, especially when boys are around. And I think it’s sad because Susan doesn’t look as happy. To tell you the truth, she doesn’t like to admit she’s in the advanced english class, and she doesn’t like to say “hi” to me in the hall anymore.
...
which was a big deal at any school. They call it “going out” in high school. And they kissed and talked about movies, and she missed him terribly because he was her best friend.
...
Anyway, the reason I am writing to you is because I saw my brother on television. I normally don’t like sports too much, but this was a special occasion. My mother started crying, and my father put his arm around her

shoulder, and my sister smiled, which is funny because my brother and sister always fight when he’s around.
...
listened to it. And loved it very much. There is one song called “Asleep” that I would like you to listen to. I told my sister about it.
And a week later she thanked me because when this boy asked her about the tape, she said exactly what I said about the song “Asleep,” and this boy was very moved by how much it meant to her. I hope this means I will be good at dating when the time comes.
...
That weekend, my sister spent a lot of time with this boy. And they laughed a lot more than they usually did. On Friday night, I was reading my new book, but my brain got tired, so I decided to watch some television instead. And I
...
And I felt very bad for both of them. Love always,
Charlie
...
The point, though, is that there is a guy in shop class named “Nothing.” I’m not kidding. His name is
“Nothing.” And he is hilarious. “Nothing” got his name when kids used to tease him in middle school. I think he’s a senior now. The kids started calling him Patty when his real name is Patrick. And “Nothing”
told these kids, “Listen, you either call me Patrick, or you call me nothing.”
So, the kids started calling him “Nothing.” And the name just stuck. He was a new kid in the school district at the time because his dad married a new woman in this area. I think I will stop putting quotation marks around Nothing’s name because it is annoying and disrupting my flow. I hope you do not find this difficult to follow. I will make sure to differentiate if something
...
To tell you the truth, I don’t know where they are appropriate to use. I’m not saying that you shouldn’t know them. You should absolutely. But I just have never heard anyone use the words “corpulent” and
“jaundice” ever in my life. That includes teachers. So, what’s the point of using words nobody else knows or can say comfortably? I just don’t understand that.
...
They start with what food they are eating in some restaurant. “As –- gingerly munched her Chinese Chicken Salad, she spoke of love.” And all the covers say the same thing: “–- gets to the bottom of stardom, love, and hissther hit

new moviesttelevision showstalbum.”
I think it’s nice for stars to do interviews to make us think they are just like us, but to tell you the truth, I get the feeling that it’s all a big lie. The problem is I don’t know who’s lying. And I don’t know why Page 8
these magazines sell as much as they do. And I don’t know why the ladies in the dentist’s office like them as much as they do. A Saturday ago, I was in the dentist’s office, and I heard this conversation.
...
“Did you read the interview in Good Housekeeping?” “A few months back?”
“Uh-huh.”
“Disgraceful.”
...
The fact that one of these ladies was my mom made me feel particularly sad because my mom is beautiful. And she’s always on a diet. Sometimes, my dad
...
“Okay,” I said.
And Dad picked me up with the arm that wasn’t holding the sandwich, and carried me to the room that had the television, and put me on his lap for the

rest of the television episode. At the end of the episode, he picked me up, turned off the TV, and turned around.
...
And my sister responded, “You ... stupid.” And my dad said, “Stop it, right now.” And my mom said, “Listen to your father.” And my brother said nothing.
...
“Hey, you’re in my shop class!” He’s a very friendly person. “I’m Charlie.” I said, not too shy.
...
“I think maybe the Smiths because I love their song Àsleep,’ but I’m really not sure one way or the other because I don’t know any other songs by them too well.”
“What’s your favorite movie?”
“I don’t know really. They’re all the same to me.” “How about your favorite book?”
” This Side of Paradise by From. Scott Fitzgerald.” “Why?”
...
“How long have you been `going out’?” I asked. Then, they started laughing. Really laughing hard. “What’s so funny?” I said.
“We’re brother and sister,” Patrick said, still laughing. “But you don’t look alike,” I said.
...
“You know you’re too young for me, Charlie? You do know that?” “Yes, I do.”
“I don’t want you to waste your time thinking about me that way.” “I won’t. It was just a dream.”
...
thinking about, and I told him. He listened, and he nodded and made “affirmation” sounds. When I had finished, his face changed into a “serious talk” face.
“Do you always think this much, Charlie?”
“Is that bad?” I just wanted someone to tell me the truth.
“Not necessarily. It’s just that sometimes people use thought to not participate in life.”
“Is that bad?”
“Yes.”
“I think I participate, though. Don’t you think I am?” “Well, are you dancing at these dances?”
...
My sister was crying. My mom was very very quiet. My dad did all the talking. He said that my sister was not allowed to see the boy who hit her

anymore, and he was going to have a talk with the boy’s parents tonight. My sister then said that it was all her fault, that she was provoking him, but my dad said it was no excuse.
“But I love him!” I had never seen my sister cry that much. “No, you don’t.”
“I hate you!”
“No, you don’t.” My dad can be very calm sometimes. “He’s my whole world.”
...
Well, if you are wondering, he didn’t. He never touched my brother or sister. And the only time he ever slapped me was when I made my Aunt Helen cry. And once we all calmed down, he got on his knees in front of me and said

that his stepdad hit him a lot, and he decided in college when my mom got pregnant with my older brother that he would never hit his kids. And he felt terrible for doing it. And he was so sorry. And he would never hit me again. And he hasn’t.
He’s just stern sometimes. Love always,
Charlie
...
“Not everyone has a sob story, Charlie, and even if they do, it’s no excuse.” That’s all he said. And then we went to watch television.
My sister is still mad at me, but my dad said I did the right thing. I hope that I

did, but it’s hard to tell sometimes. Love always,
Charlie
...
In terms of my participation in things, I am trying to go to social events that they set up in my school.
It’s too late to join any clubs or anything like that, but I still try to go to the things that I can. Things like the homecoming football game and dance, even if I don’t have a date.
...
And then I walked away. I went down to the concession stand and bought three boxes of nachos and a diet coke for Sam. When I returned, I sat down

and gave Patrick and Sam the nachos and Sam her diet coke. And Sam smiled. The great thing about Sam is that she doesn’t think I’m crazy for pretending to do things. Patrick doesn’t either, but he was too busy watching the game and screaming at Brad, the quarterback.
...
“Please. Dave. No.”
But the boy just talked soft to her about how good she looked and things like that, and she grabbed his penis with her hands and started moving it. I wish I

could describe this a little more nicely without using words like penis, but that was the way it was.
...
My sister was making out in the laundry room with some senior. She was a freshman at the time. A lot of parents came to the house then to pick up their kids, and a lot of the girls were crying and throwing up.
Most of the boys had run away by this point. My brother got in big trouble, and my sister was given a
...
“Patrick known as Patty known as Nothing?” “Bob.”
...
When he came back, he brought a can of Milwaukee’s Best beer for everyone, as well as two new party guests. There was Maggie, who needed to use the bathroom. And there was Brad, the quarterback of the high school football team. No kidding!
...
Everyone was very friendly to me and asked me a lot of questions about myself. I guess because I was the youngest, and they didn’t want me to feel out of place, especially after I said no to having a beer.
I once had a beer with my brother when I was twelve, and I just didn’t like it. It’s really that simple for me.
...
“Would you like a brownie?” “Yes. Thank you.”
...
“A milkshake.”
And everyone in the room, except Sam, erupted in laughter. “He’s stoned.”
...
“Brad doesn’t want people to know.” “Why?”
“Because he’s scared.”
“Why?”
...
“Listen, Charlie. Brad doesn’t want people to know. I need you to promise that you won’t tell anyone.
This will be our little secret. Okay?” “Okay.”
“Thanks.”
...
And Patrick smiled more. I don’t think I ever saw Patrick smile so much. Then, Patrick pointed at me, and said something to Bob.
...
Bob raised his drink and asked everyone to do the same. “To Charlie.”
...
And in that moment, I swear we were infinite. Love always,
Charlie
...
When I got home, I had to mow the lawn for my allowance, and I didn’t mind one bit. I just listened to the music, and breathed in the day, and remembered things. Things like walking around the neighborhood and looking at the houses and the lawns and the colorful trees and having that be enough.
...
One thing I remember is that the kids used to play a game. What you would do is take a football or something, and one person would have it, and all the other kids would try to tackle that kid. And then whoever got the ball next would run around with it, and the kids would try to tackle him. This could go on for hours. I never really understood the point of this game, but my brother loved it. He didn’t like to run with the ball so much as he liked to tackle people. The kids called the game “smear the queer.” I didn’t really think about what that means until now.
...
Patrick and Brad both got pretty drunk at this party. Actually, Patrick said that Brad was pretending to be a lot drunker than he really was. They were sitting in the basement with some girl named Heather, and when she left to go to the bathroom, Brad and Patrick were left alone. Patrick said it was uncomfortable

and exciting for both of them.
“You’re in Mr. Brosnahan’s class, right?”
“Have you ever gone to a Pink Floyd Laser Light Show?” “Beer before liquor. Never sicker.”
...
When summer came, Brad didn’t have to worry about school or anything, so his drinking and smoking got a lot worse. There was a big party at Patrick and Sam’s house with the less than popular crowd.
Brad showed up, which caused quite a stir because he was popular, but Patrick kept a secret as to why Brad came to the party. When most people left, Brad and Patrick went into Patrick’s room.
...
the movie because Sam walks around in her underwear when she plays Janet. I am really trying not to think of her that way, which is becoming increasingly difficult.
...
And the guy said, “Huh?” And the whole team laughed.
...
I think about all this sometimes when I’m watching a football game with Patrick and Sam. I look at the field, and I think about the boy who just made the touchdown. I think that these are the glory days for that boy, and this

moment will just be another story someday because all the people who make touchdowns and home runs will become somebody’s dad. And when his children look at his yearbook photograph, they will think that their dad was rugged and handsome and looked a lot happier than they are.
...
“Well, Mrs. Lambert doesn’t like baseballs going into her yard.” “What about those people?”
...
“Is who sick?”
“Mrs. Tanner’s mother.”
“I don’t think so. My mom would know, and she didn’t say anything.” Michael nodded. “They’re getting a divorce.”
“You think so?”
“Uh-huh.”
...
My mom usually helps her aunt prepare the food, which my grandfather always says is “too dry” even if it’s soup. And her aunt will then cry and lock herself in the bathroom.
...
the retirement home, and I rode along. My brother always understood my grandfather. He rarely got angry at him unless my grandfather said something mean about my mom or sister or made a scene in public. I remember it was snowing really hard, and it was very quiet. Almost peaceful. And my grandfather calmed down and started talking a different kind of talk.
...
“I know how your mom feels about me. I know Helen, too. There was one time ... I went to the mill
...
Blues Daydream by Smashing Pumpkins Dusk by Genesis (before Phil Collins was even in the band!) MLK by Ubleb Blackbird by the Beatles Landslide by Fleetwood Mac And finally ...
...
Wow. Wow. I can paint the picture for you if you like. We are all sitting in Sam and Patrick’s house, which I had never seen before. It was a rich house. Very clean. And we were all giving our final presents.
The outside lights were on, and it was snowing, and it looked like magic. Like we were somewhere else.
Like we were someplace better.
It was the first time I had ever met Sam and Patrick’s parents. They were so nice. Sam’s mom is very pretty and tells great jokes. Sam said she used to be an actress when she was younger. Patrick’s dad is very tall and has a great handshake. He is also a very good cook. A lot of parents make you feel very

awkward when you meet them. But not Sam and Patrick’s. They were friendly all through dinner, and when dinner was over, they left so we could have our party. They didn’t even check on us or anything.
Not once. They just let us pretend it was our house. So, we decided to have the party in the “games”
...
When I was done reading the poem, everyone was quiet. A very sad quiet. But the amazing thing was that it wasn’t a bad sad at all. It was just something that made everyone look around at each other and know that they were there. Sam and Patrick looked at me. And I looked at them. And I think they knew.
...
As the songs kept playing, Mary Elizabeth stood up. But she wasn’t holding a suit coat. It turns out that she wasn’t my Secret Santa at all. She was the Secret Santa to the other girl with the tattoo and belly button ring, whose real name is Alice. She gave her some black nail polish that Alice had had her eye on.
And Alice was very grateful. I just sat there, looking around the room. Looking for the suit coat. Not knowing who could possibly be holding it.
...
Everyone did. And he came out with three tubes of Pringles and a suit coat. And he walked up to me.
...
And she looked at me funny. Then, they all started to look at me funny except for Sam and Patrick. I think they started feeling bad because they didn’t get me anything. But I don’t think they should have because I don’t think that’s

the point really. Mary Elizabeth just smiled, and said thanks, and then stopped looking at me in the eye.
...
“I just want to make sure of that. Okay?” “Okay.”
...
Because that’s what it was really all about And he gave himself an A and a slash on each damned wrist And he hung it on the bathroom door because this time he didn’t think he could reach the kitchen.
...
I walked over to the hill where we used to go and sled. There were a lot of little kids there. I watched them flying. Doing jumps and having races. And I thought that all those little kids are going to grow up someday. And all of those little kids are going to do the things that we do. And they will all kiss

someone someday. But for now, sledding is enough. I think it would be great if sledding were always enough, but it isn’t.
I’m really glad that Christmas and my birthday are soon because that means they will be over soon because I can already feel myself going to a bad place I used to go. After my Aunt Helen was gone, I went to that place. It got so bad that my mom had to take me to a doctor, and I was held back a grade.
But now I’m trying not to think about it too much because that makes it worse.
It’s kind of like when you look at yourself in the mirror and you say your name. And it gets to a point where none of it seems real. Well, sometimes, I can do that, but I don’t need an hour in front of a mirror.
It happens very fast, and things start to slip away. And I just open my eyes, and I see nothing. And then I start to breathe really hard trying to see something, but I can’t. It doesn’t happen all the time, but when it does, it scares me.
...
I am sitting in my dad’s old bedroom in Ohio. The family is still downstairs. I really don’t feel very well. I don’t know what’s wrong with me, but I’m starting to get scared. I wish we were going back home tonight, but we always sleep over. I don’t want to tell my mom about it because it would just make her worry.dc I would tell Sam and Patrick, but they didn’t call yesterday. And we left this morning after we opened presents. Maybe they called this afternoon. I hope they didn’t call this afternoon because I wasn’t there. I hope it’s okay that I’m telling you this. I just don’t know what else to do. I always get sad when this happens, and I wish Michael were here. And I wish my Aunt Helen were here. I miss my Aunt Helen like this. Reading the book isn’t helping either. I don’t know. I’m just thinking too fast. Much too fast. It’s like tonight.
The family watched It’s a Wonderful Life, which is a very beautiful movie. And all I could think was why didn’t they make the movie about Uncle Billy? George Bailey was an important man in the town.
Because of him, a whole bunch of people got to get out of the slums. He saved a town, and when his dad died, he was the only guy who could do it. He wanted to live an adventure, but he stayed behind and sacrificed his dreams for the better good of the community. And then when that made him sad, he was going to kill himself. He was going to die because his life insurance money would have taken care of his family. And then an angel comes down and shows him what life would be if he had never been born.
How the whole town would have suffered. And how his wife would have been an “old maid.” And my sister didn’t even say anything about how that’s such an old-fashioned thing, this year. Every other year she says something about how Mary was working for a living, and just because she’s not married, it doesn’t mean that she is worthless. But this year she didn’t. I didn’t know why. I thought it might be about that secret boy of hers. Or maybe it’s what happened in the car on the way over to our grandma’s house.
I just wanted the movie to be about Uncle Billy because he drank a lot and was fat and lost the money in the first place. I wanted the angel to come down and show us how Uncle Billy’s life had meaning. Then, I think I’d feel better.
It started yesterday at home. I don’t like my birthday. I don’t like it at all. I went shopping with my mom and sister, and my mom was in a bad mood because of parking spaces and lines. And my sister was in a bad mood because she couldn’t buy her secret boy a present and hide it from Mom. She would have to come back herself later. And I felt weird. Really weird, because as I was walking around all the stores, I didn’t know what present my

dad would like to receive from me. I knew what to buy or give Sam and Patrick, but I didn’t know what I could buy or give or make for my own dad. My brother likes posters of girls and beer cans. My sister likes a haircut gift certificate. My mom likes old movies and plants. My dad only likes golf, and that is not a winter sport except for in Florida, and we don’t live there.
...
My dad doesn’t listen to music a lot anymore, and the stuff he likes, he has. “What kind of books does he like to read?”
...
“Just buy him some golf balls, Charlie. Jesus.” “But that’s a summer sport.”
“Mom. Would you make him buy something?” “Charlie. Calm down. It’s okay.”
...
My mom took me to four different stores. Each one my sister just sat in the nearest chair and groaned. I finally found the perfect store. It was a movie place. And I found a videocassette of the last episode of More”inA”inSo”inHave without the commercials. And I felt a lot better. Then, I started telling Mom about how we all watched it together.
...
We were sitting at the dinner table, waiting for my dad to come home with my brother from the airport. He was really late, and my mom started to worry because it was snowing really hard outside.
And she kept my sister at home because she needed help with dinner. She wanted it to be extra special for my brother and for me because he was coming home, and it was my birthday. But my sister just wanted to buy her boyfriend a present. She was in a really bad mood. She was being like those bratty girls in movies from the 1980’s, and my mom kept saying “Young lady” after every sentence.
...
“I’m sorry.”
My mom wouldn’t let me talk about it. She knows that I stop listening and start to really breathe fast.
...
My sister spent the next ten minutes denouncing the Greek system of sororities and fraternities. She kept telling stories of “hazing” and how kids have died before. She then told this one story about how she heard there was a sorority that made the new girls stand in their underwear while they circled their “fat” in red magic markers. My brother had had enough of my sister at
...
“Watch your mouth, young lady,” my dad said from the front seat. “Oh, yeah? Where did you hear it?” my brother asked.
...
“Oh, I’m sorry. Was anyone talking to you? I happen to be telling my younger brother about my girlfr.
Kelly says that she hopes a good Democratic candidate will challenge George Bush. Kelly says that her hope is that the E.R.A. might finally pass if that

happens. That’s right. The E.R.A. that you always squawk about. Even cheerleaders think about those things. And they can actually have fun in the meantime.”
...
“I’m sorry I said what I said about Kelly. She sounds nice.” Then, my dad turned to my mom. And my mom turned to us.
...
My dad’s family is kind of like my mom’s family. My brother once said it was like the same cousins with different names. The big difference is my grandma. I love my grandma. Everyone loves my grandma.
...
My grandma is very old, and she doesn’t remember things a lot, but she bakes the most delicious cookies. When I was very little, we had my mom’s mom, who always had candy, and my dad’s mom, who always had cookies. My mom told me that when I was little, I called them “Candy Grandma” and
“Cookies Grandma.” I also called pizza crust “pizza bones.” I don’t know why I’m telling you this.
It’s like my very first memory, which I guess is the first time I was aware that I was alive. My mom and my Aunt Helen took me to the zoo. I think I was three. I don’t remember that part. Anyway, we were watching these two cows. A mother cow and its baby calf. And they didn’t have a lot of room to walk around. Anyway, the baby calf was standing right underneath its mother, just kind of walking around, and the mother cow took a “dump” on the baby calf’s head. I thought it was the funniest thing I had ever seen in the whole world, and I laughed about it for three hours. At first, my mom and Aunt Helen kind of laughed, too, because they were happy that I was laughing. Supposedly, I didn’t talk hardly at all when I was a little kid, and whenever I seemed normal, they were happy. But into the third hour, they were trying to make me stop laughing, but it only made me laugh harder. I don’t think it was really three hours, but it seemed like a long time. I still think about it every now and then. It seems like a rather
“auspicious” beginning.
After hugs and handshakes, we went into my grandma’s house, and the whole dad-side-of-the-family was there. Great Uncle Phil with his fake teeth and my aunt Rebecca, who is my dad’s sister. Mom told us that Aunt Rebecca just got

divorced again, so we shouldn’t mention anything. All I could think about was the cookies, but Grandma didn’t make them this year because of her bad hip.
...
I will not say who. I will not say when. I will just say that my aunt Helen was molested. I hate that word. It was done by someone who was very close to her. It was not her dad. She finally told her dad.
He didn’t believe her because of who it was. A friend of the family. That just made it worse. My grandma never said anything either. And the man kept coming over for visits.
My aunt Helen drank a lot. My aunt Helen took drugs a lot. My aunt Helen had many problems with men and boys. She was a very unhappy person most of her life. She went to hospitals all the time. All kinds of hospitals. Finally, she went to a hospital that helped her figure things out enough to try and make things normal, so she moved in with my family. She started taking classes to get a good job. She told her last bad man to leave her alone. She started losing weight without going on a diet. She took care of us, so my parents could go out and drink and play board games. She let us stay up late. She was the only person other than my mom and dad and brother and sister to buy me two presents. One for my birthday.

One for Christmas. Even when she moved in with the family and had no money. She always bought me two presents. They were always the best presents.
On December 24, 1983, a policeman came to the door. My aunt Helen was in a terrible car accident.
It was very snowy. The policeman told my mom that my aunt Helen had passed away. He was a very nice man because when my mom started crying, he said that it was a very bad accident, and my Aunt Helen was definitely killed instantly. In other words, there was no pain. There was no pain anymore.
The policeman asked my mom to come down and identify the body. My dad was still at work. That was when I walked up with my brother and sister. It was my seventh birthday. We all wore party hats.
My mom made my sister and brother wear them. My sister saw Mom crying and asked what was wrong. My mom couldn’t say anything. The policeman got on one knee and told us what happened. My brother and sister cried. But I didn’t. I knew that the policeman made a mistake.
...
“Why the long faces?”
We told him. He did not cry. He asked if we were okay. My brother and sister said no. I said yes.
The policeman just made a mistake. It is very snowy. He probably couldn’t see. My mom came home.
She was crying. She looked at my dad and nodded. My dad held her. That’s when I figured out that the policeman didn’t make a mistake.
...
I told my aunt Helen all about my life. About Sam and Patrick. About their friends. About my first New Year’s Eve party tomorrow. I told her about how my brother would be playing his last football game of the season on New Year’s Day. I told her about my brother leaving and how my mom cried. I told

her about the books I read. I told her about the song “Asleep.” I told her when we all felt infinite. I told her about me getting my driver’s license. How my mom drove us there. And how I drove us back.
...
It’s peaceful outside. I do know that. And I drove to the Big Boy earlier. And I saw Sam and Patrick.
And they were with Brad and Craig. And it made me very sad because I wanted to be alone with them.
...
My cheeks were red cold just like Mr. Z’s drinking face and his black shoes and his voice saying when a caterpillar goes into a cocoon, it goes through torture and how it takes seven years to digest gum.
...
because maybe if I do I won’t have to think about it. And I won’t get upset. But the thing is that I can hear Sam and Craig having sex, and for the first time in my life, I understand the end of that poem.
And I never wanted to. You have to believe me. Love always,
Charlie
...
My brother ... football ... Brad ... Dave and his girlfr in my room ... the coats ... the cold ... the winter
... “Autumn Leaves” ... don’t tell anyone ... you pervert ... Sam and Craig ... Sam ... Christmas ...
typewriter ... gift ... Aunt Helen ... and the trees kept moving ... they just wouldn’t stop moving ... so I laid down and made a snow angel.
...
I just kept quiet and looked around. And I noticed things. The dots on the ceiling. Or how the blanket they gave me was rough. Or how the doctor’s face looked rubbery. Or how everything was a deafening whisper, when he said

that maybe I should start seeing a psychiatrist again. It was the first time a doctor ever told that to my parents with me in the room. And his coat was so white. And I was so tired.
...
Regardless, I decided to never take LSD again. Love always,
Charlie
...
And I focused on the piece of paper that was sitting on the ground. “Is the cement moving now?”
“No. It’s not.”
...
Things have stopped moving for the most part ever since. I haven’t skipped another class. And I guess now I don’t feel like a big faker for trying to put my life back together. Bill thought my paper on The Catcher in the Rye (which I wrote on my new old typewriter!) was my best one yet. He said I was
“developing” at a rapid pace and gave me a different kind of book as “a reward.” It’s On the Road by Jack Kerouac.
I’m now up to about ten cigarettes a day. Love always,
Charlie
...
My psychiatrist is a very nice man. He’s much better than my last psychiatrist. We talk about things that I feel and think and remember. Like when I was little, and there was this one time that I walked down the street in my neighborhood. I was completely naked, holding a bright blue umbrella, even

though it wasn’t raining. And I was so happy because it made my mom smile. And she rarely smiled. So, she took a picture. And the neighbors complained.
This other time, I saw a commercial for this movie about a man who was accused of murder, but he didn’t commit the murder. A guy from More”inA”inSo”inHave was the star of the movie. That’s probably why I remember it. The commercial said that the whole movie was about him trying to prove that he was innocent and how he could go to jail anyway. That scared me a lot. It scared me how much it scared me. Being punished for something you did not do. Or being an innocent victim. It’s just something that I never want to experience.
I don’t know if it is important to tell you all this, but at the time, it felt like a “breakthrough.”
The best thing about my psychiatrist is that he has music magazines in his waiting room. I read an article about Nirvana on one visit, and it didn’t have any references to honey mustard dressing or lettuce.
...
Anyway, they have this discussion, and the kid is an idealist in a temporary way. He talks about his
...
I don’t know. I just had a great day. I hope you did, too. Love always,
...
I’ve read about a third of the book now, and it’s pretty good so far. Love always,
Charlie
...
I have to say something about my last letter. I know that Sam would never ask me to the dance. I know that she would bring Craig, and if not Craig, then Patrick since Brad’s girlfr, Nancy, is going with Brad. I think Mary Elizabeth

is a really smart and pretty person, and I’m glad that she is my first date ever. But after I said yes, and Mary Elizabeth announced it to the group, I wanted Sam to be jealous. I know it’s wrong to want something like that, but I really did.
Sam wasn’t jealous, though. To tell you the truth, I don’t think she could have been happier about it, which was hard.
She even told me how to treat a girl on a date, which was very interesting. She said that with a girl like Mary Elizabeth, you shouldn’t tell her she looks pretty. You should tell her how nice her outfit is because her outfit is her choice whereas her face isn’t. She also said that with some girls, you should do things like open car doors and buy flowers, but with Mary Elizabeth (especially since it’s the Sadie Hawkins’
dance), I shouldn’t do that. So, I asked her what I should do, and she said that I should ask a lot of questions and not mind when Mary Elizabeth doesn’t stop talking. I said that it didn’t sound very democratic, but Sam said she does it all the time with boys.
...
I don’t feel very well because everything is messy. I did go to the dance, and I did tell Mary Elizabeth how nice her outfit was. I did ask her questions, and I let her talk the whole time. I learned a lot about
“objectification,” Native Americans, and the bourgeoisie. But most of all, I learned about Mary Elizabeth.
...
The only thing she asked me the whole time was whether or not I wanted to kiss her good night.
When I said that I wasn’t ready, she said she understood and told me what a great time she had. She said I was the most sensitive boy she’d ever met, which I didn’t understand because really all I did was not interrupt her.
...
“Not really. Are you?”
“I don’t know. This is my first date, so I don’t know what to compare it to.” “Don’t worry. You’ll do fine.”
“Really?”
“You want some punch?”
“Sure.”
...
That’s when she really started crying. I didn’t want to make her feel worse, so I turned to leave her alone. That’s when my sister started hugging me. She didn’t say anything. She just hugged me tight and wouldn’t let go. So, I

hugged her back. It was weird, too, because I’ve never hugged my sister. Not when she wasn’t forced to anyway. After a while, she calmed down a bit and let go. She took a deep breath and brushed off the hair that was sticking to her face.
...
I said that to make her laugh. But she didn’t. Love always,
Charlie
...
I could almost see the photo shoot and the actress or model going to eat a “light lunch” with her boyfriend afterward. I could see him asking her about her day, and how she wouldn’t think too much of it, or maybe if it was her first magazine cover, how she would be very excited because she was starting to become famous. I could see the magazine on the newsstands, and a lot of anonymous eyes looking at it, and how some people would think it was very

important. And then how a girl like Mary Elizabeth would be very angry about the actress or model showing her cleavage along with all the other actresses and models doing the same thing, while some photographer like Craig would just look at the quality of the photograph. Then, I thought there would be some men who would buy the magazine and masturbate to it. And I wondered what the actress or her boyfriend thought about that, if they did at all. And then I thought that it was about time for me to stop thinking because it wasn’t doing my sister any good.
That’s when I started thinking about my sister.
I thought about the time when she and her friends painted my fingernails, and how that was okay because my brother wasn’t there. And the time she let me use her dolls to make up plays or let me watch whatever I wanted to watch on TV. And when she started becoming a “young lady,” and no one was allowed to look at her because she thought she was fat. And how she really wasn’t fat. And how she was actually very pretty. And how different her face looked when she realized boys thought she was pretty.
And how different her face looked the first time she really liked a boy who was not on a poster on her wall. And how her face looked when she realized she was in love with that boy. And then I wondered how her face would look when she came out from behind those doors.
...
she could have said right after she got out of there, she picked my smoking. And she got angry about it. And I knew if my sister was angry, then her face wouldn’t be that different. And she would be okay.
...
Eventually, my laughing turned into the occasional chuckle, and then it just stopped. I looked back and saw that my sister was asleep. So, I started the car and turned on the heater, so she would be warm.
...
That night, after our parents went to sleep, I went down to the car and got the pillow and blanket out of the trunk. I brought them to my sister in her room. She was pretty tired. And she spoke very softly.
She thanked me for the whole day. She said that I didn’t let her down. And she said that she wanted it to be our little secret since she decided to tell her old boyfriend that the pregnancy was a false alarm. I guess she just didn’t trust him with the truth anymore.

Just after I turned out the lights and opened the door, I heard her say softly, “I want you to stop smoking, you hear?”
“I hear.”
...
That’s when Michelle hung up on me. And I didn’t mind a bit. Love always,
Charlie
...
“What for?” My dad gets protective of his car. “Charlie’s got a girlfr,” my sister said.
...
“That’s what I’m trying to find out!” my father said with a raised voice. “No need to get snippy,” my mother said.
“Sorry,” my father said without meaning it. Then, he turned back to me. “So, tell me about this girl.”
So, I told him a little about Mary Elizabeth, leaving out the part about the tattoo and belly button ring.
He kind of smiled for a little while, trying to see if I was already guilty of something. Then, he said yes. I could borrow his car. When my mother came in with coffee, my father told her the whole story while I ate dessert.
...
She asked me to pour the drinks while she made a fire. She was very excited, too, which was strange because she’s never like that. She kept talking about how much she loves fires and how she wanted to marry a man and live in

Vermont someday, which was strange, too, because Mary Elizabeth never talks about things like that. When she finished the fire, she put on the record, and kind of danced over to me.
...
My heart was beating really fast, and I was starting to get nervous. She handed me another glass of brandy and touched my hand very softly when she did it. Then, she slipped her leg over mine, and I watched it just dangle there. Then, I felt her hand on the back of my neck. Just kind of moving slowly.
And my heart started beating crazy.
“Do you like the record?” she asked real quiet. “Very much.” I really did, too. It was beautiful. “Charlie?”
“Uh-huh?”
“Do you like me?”
“Uh-huh.”
...
After we had done everything you can do from the stomach up, I lay down on the floor, and Mary Elizabeth put her head on my chest. We both breathed

very slowly and listened to the music and the fire crack. When the last song was over, I felt her breath on my chest.
“Charlie?”
“Uh-huh?”
“Do you think I’m pretty?” “I think you’re very pretty.” “Really?”
“Really.”
...
Thank God we heard the automatic garage door opener when we did. Love always,
Charlie
...
I don’t know if this is right or not, but it made me sad regardless. Not for Mary Elizabeth. Or for me.
Just in general. Because I started to think that I didn’t know who Mary Elizabeth was at all. I’m not saying she was lying to me, but she just acted so different before I got to know her, and if she really isn’t like what she was at the beginning, I wish she could have just said so. But maybe she is like she was at the beginning, and I just didn’t realize it. I just don’t want to be another thing Mary Elizabeth is in charge of.
I asked my sister what I should do, and she said the best thing to do is be honest about my feelings.
My psychiatrist said the same thing. And then I felt really sad because I thought maybe I was different from how Mary Elizabeth originally saw me, too. And maybe I was lying by not telling her that it was hard to listen to her all the time without getting to say anything back. But I was just trying to be nice like Sam said I should. I don’t know where I went wrong.
I tried to call my brother about this, but his roommate said he was really busy with school, so I decided not to leave a message because I didn’t want to

distract him. The one thing I did was mail my report about Walden to him, so he could share it with his girlfr. Then, maybe if they had time, they could read it, and we could talk about it, and I would have the chance to ask them both what to do about Mary Elizabeth since they were going out in a good way and would know how to make things work. Even if we didn’t get to talk about it, I would still love to meet my brother’s girlfr. Even on the phone. I did get to see her once on a VCR tape of one of my brother’s football games, but it’s really not the same thing.
Even though she was very beautiful. But not in an unconventional way. I don’t know why I’m saying all this. I just wish Mary Elizabeth would ask me questions other than “What’s up?”
Love always,
Charlie
...
and how they turned it into a black-and-white film with famous actors like Gregory Peck and Robert Duvall that won an Academy Award for the screenplay writer. I just kind of put my feelings away somewhere after that.
...
The next day in school, when Mary Elizabeth asked where I had been the day before, I told her that I bought a pack of cigarettes, went to the Big Boy, and spent the entire day reading the every. every.

cummings book and eating club sandwiches. I knew I was safe saying that because she would never ask me any questions about the book. And I was right. After she got done talking about it that time, I didn’t think I’d ever really need to read it myself. Even if I wanted to.
...
What made it special was the fact that everyone knew it was the beginning of Easter vacation, and a lot of kids were still wearing their suits and dresses from Mass. It reminded me of Ash Wednesday in school when the kids come in with thumbprints on their foreheads. It always adds an air of excitement.
...
I could say that it was the wine or the beer that I chugged. I could also say that I had forgotten the time Mary Elizabeth asked me if I thought she was pretty. But I would be lying. The truth is that when Patrick dared me, I knew

that if I kissed Mary Elizabeth, I would be lying to everyone. Including Sam.
Including Patrick. Including Mary Elizabeth. And I just couldn’t do it anymore. Even if it was part of a game.
...
“Then again, if you were gay, I would never date you. You’re a mess.” That made me start laughing a little bit.
...
Something really is wrong with me. And I don’t know what it is. Love always,
Charlie
...
Patrick did call me, but all he said was that Craig got really angry at Sam about me, and I should keep staying away until things got clear. I asked him if he would like to go out, just him and me. He said that he would be busy with

Brad and family things, but he’d try to call me if he could find the time. So far, he hasn’t.
...
My brother did come home, but when I asked him if his girlfr read my report on Walden, he said no because she broke up with him when she found out he was cheating on her. That happened a while ago.
...
So, I took some of my Easter money and bought it. I’ve been smoking it all the time since.
Love always,
Charlie
...
I guess the mom had been searching for the little boy for a long time because she came running up to the information desk, and when she saw the little boy,

she started crying. She held him tightly and told him to never run off again. Then, she thanked the older kid who had helped, and all the older kid said was, “Next time just watch him a little fucking better.”
Then, he walked away.
...
Bob says that when you’re alone, and you light a cigarette, and the cigarette is only halfway lit that means someone is thinking about you. He also says that

when you find a penny, it’s only “lucky” if it’s heads-up. He says the best thing to do is find a lucky penny when you’re with someone and give the other person the good luck. He believes in karma. He also loves to play cards.
...
That’s what made it such a shock when he told me what happened. Basically, Brad’s father caught Brad and Patrick together.
...
My sister said, “It’s stupid. You wouldn’t like it.” I said, “What’s it about?”
...
That’s when she paused the movie. “Can’t you take a hint?”
“I suppose not.”
“We want to be alone, Charlie.” “Oh. I’m sorry.”
...
I went up to my room and started reading the new book Bill gave me. It’s called The Stranger. Bill said that it’s “very easy to read, but very hard tòread well.’” I have no idea what he means, but I like the book so far.
...
“Faggot!”
Brad’s football buddies start laughing. A few tables got quiet as Patrick turned around. He was mad as hell. I’m not kidding. He stormed up to Brad’s table
...
He didn’t say anything back, though, because the security guards of our school came to bring all of us out of the cafeteria. They took us first to the nurse, and then to Mr. Small. Patrick started the fight, so he was suspended for a week. Brad’s buddies got three days each for ganging up on Patrick after they broke up the original fight. Brad wasn’t suspended at all because it was

self-defense. I didn’t get suspended either because I was just helping to defend a friend when it was five on one.
...
“Charlie?”
“Yeah?”
“Thanks. Thanks for stopping them.” “You’re welcome.”
...
“So, I heard you’re this ninja or something.” I think I nodded.
...
So, she said that when I kissed her instead of Mary Elizabeth, I really hurt their friendship for a while.

Because I guess Mary Elizabeth really liked me a lot. That made me feel sad because I didn’t know that she liked me that much. I just thought she wanted to expose me to all those great things. That’s when Sam said,
“Charlie, you’re so stupid sometimes. Do you know that?” “Yeah. I really do. Know that. Honest.”
...
that Mary Elizabeth started dating one of Craig’s friends. His name is Peter, and he’s in college, which makes Mary Elizabeth happy.
...
But I was at a party with my friends, so it really didn’t matter that much. I just drank because I figured that it was about time to stop smoking so much pot.
The thing that made the evening tense was Patrick officially quit doing Frank ‘Not Furter in the show.
He said that he didn’t want to do it anymore ... ever. So, he sat and watched the show in the audience with me, and he said things that were hard to listen to because Patrick usually isn’t unhappy.
...
So, I got up and wiped away the sleep. “Hello?”
...
He hadn’t showered or anything. I don’t even think he went to bed. He was just wide awake on coffee and cigarettes and Mini Thins, which are these small pills you can buy at Quick Marts or Truck Stops.
...
“Your parents don’t know you smoke?” “No. Should they?”
“I guess not.”
...
“I’ll tell you something, Charlie. I feel good. You know what I mean? Really good. Like I’m free or something. Like I don’t have to pretend anymore. I’m going away to college, right? It’ll be different there.
You know what I mean?” “Sure,” I said.
...
By this point, Patrick had bought a bottle of red wine with his fake ID, and we passed it back and forth.
Just talking.
...
“Okay. Okay. I’m sorry. So, they have this picnic with sandwiches and everything. They start to make out. The stereo’s playing, and they’re just about tòdo it’ when Parker realizes he forgot the condoms.
...
There was a kid named Barry, who used to build kites in art class. Then, after school, he would attach firecrackers to the kite and fly it and blow it up. He’s

now studying to be an air traffic controller. — Patrick’s story via Sam
...
day C.B. got so drunk at a party that he tried to “fuck” the host’s dog. — Patrick’s story
And there was this guy they called “Action Jack” because supposedly he was caught masturbating at a drunk party. And at every pep rally, the kids would clap and chant. Action Jack ... clap clap clap ...
Action Jack!
— my story via my brother
There were other stories and other names. Second Base Stace, who had breasts in the fourth grade and let some of the boys feel them. Vincent, who took acid and tried to flush a sofa down the toilet.
Sheila, who allegedly masturbated with a hot dog and had to go to the emergency room. The list went on and on.
By the end, all I could think was what these people must feel like when they go to their class reunions.
...
“Thanks, Charlie.”
“Sure.”
“No. I mean in the cafeteria.” “Sure.”
...
And I just let him. Because that’s what friends are for. Love always,
Charlie
...
I just sat on a bench, looking around. All I saw were the shadows of people. Some on the ground.
Some by a tree. Some just walking. It was so quiet. After a few minutes, I lit a cigarette, and I heard somebody whisper.
...
Instead of just leaning down and lighting the cigarette, he reached out to make a cup around the match with our hands, which is something we all do when it’s windy. But it wasn’t windy. I think he just wanted to touch my hands because while he was lighting the cigarette, he did it for a lot longer than necessary.
Maybe he wanted me to see his face over the glow of the match. To see how handsome he was. I don’t know. He did look familiar. But I couldn’t figure out from where.
...
They didn’t have poppers, but the guy behind the counter said that he had something that was just as good. So, Patrick bought that. It was in this aerosal can. We both took a sniff of it, and I swear we both thought we were going to die of a heart attack.
All in all, I think Patrick took me to about every place there is to go that I

wouldn’t have known about otherwise. There was this karaoke bar on one of the main streets in the city. And there was this dance club. And this one bathroom in this one gym. All these places. Sometimes, Patrick would pick up guys.
Sometimes, he wouldn’t. He said that it was hard being safe. And you never know.
The nights he would pick up someone always made him sad. It’s hard, too, because Patrick began every night really excited. He always said he felt free. And tonight was his destiny. And things like that.
But by the end of that night, he just looked sad. Sometimes, he would talk about Brad. Sometimes, he wouldn’t. But after a while, the whole thing just wasn’t interesting to him anymore, and he ran out of things to keep himself numb.
...
Mary Elizabeth is taking her new boyfriend, Peter. My sister is taking Erik. Patrick is going with Alice.
And Craig agreed to go with Sam this time. They have even rented a limo and everything. Not my sister, though. She’s going in her new boyfriend’s car, which is a Buick.
Bill has been very sentimental lately because he can feel his first year of teaching coming to an end. At least that’s what he said to me. He was planning on moving to New York and writing plays, but he told me that he doesn’t really think he wants to anymore. He really likes teaching kids
...
I haven’t started reading it because I am very behind in my other classes because I spent so much time with Patrick. But if I can catch up, I will end my first year with straight A’s, which makes me very happy.
...
sister said it’s a tradition at a lot of schools. This year, the prank was as follows: Some seniors filled the swimming pool with about six thousand packages of grape Kool-Aid. I have no idea who thinks of these things or why, except that the senior prank is supposed to signify the end of school. What this has to do with a grape pool is beyond me, but I was very happy not to have gym.
It’s actually been a very exciting time because we’ve all been busy finishing up the year. This Friday is the last day of school for all of my friends and my sister. They’ve been talking about their prom nonstop.
...
Incidentally, I finished The Fountainhead. It was a really great experience. It’s strange to describe reading a book as a really great experience, but that’s

kind of how it felt. It was a different book from the others because it wasn’t about being a kid. And it wasn’t like The Stranger or Naked Lunch even though I think it was philosophical in a way. But it wasn’t like you had to really search for the philosophy.
...
I asked my sister if she wanted to come to Craig’s for the party afterward, but she said that one of her friends was having a party, so she was going to that. That was okay with me because at least she came to the show. And before she left, she hugged me again. Two in one day! I really do love my sister.
...
So, I just sat there with a bottle of champagne near the CD player, and I changed the songs to fit the mood of what I saw. I was lucky, too, because

Craig has an excellent collection. When people looked a little tired, I played something fun. When they looked like they wanted to talk, I played something soft. It was a great way to sit alone at a party and still feel a part of things.
...
And that Alice is secretly a lesbian and in love with Brad’s girlfr Nancy (and vice versa), so nobody feels left out. I hope the deejay is as good as everyone said I was last Friday. And I hope everyone’s pictures turn out great and never become old photographs and nobody gets in a car accident.
That is what I really hope. Love always,
Charlie
...
Then, on Sunday, I will watch everyone graduate and spend time with my brother and all the family because of my sister. Then, I’ll probably go to Sam

and Patrick’s to celebrate their graduating. Then, I’ll have two more days of school, which doesn’t make sense because all my finals will be over. But they have some activities planned. At least that’s what I’ve heard.
The reason I am thinking so far in advance is because school is terribly lonely. I think I’ve said that before, but it’s getting harder every day. I have two finals tomorrow. History and typing. Then, on Friday, I have finals in all my other classes like gym and shop. I don’t know if there will be actual finals in these classes. Especially shop. I think Mr. Callahan will just play some of his old records for us. He did that when we were supposed to have a midterm, too, but it won’t be the same without Patrick lip-synching.
Incidentally, I got a perfect on my math final last week. Love always,
Charlie
...
It happened yesterday at Craig’s house after Rocky Horror. Like I said, Mary Elizabeth’s boyfriend, Peter, is good friends with Craig, and he kind of stepped into the middle of things. I guess he really likes Mary Elizabeth a lot and has grown to like Sam quite a bit because he’s the one who brought it up.
...
There was always some excuse. Craig called them “reasons.” “I don’t want to ruin the prom for her.”
...
Peter went along with this logic even though he thought it was wrong. At least that’s what he said. But then after the show yesterday, Craig told him that he fooled around with yet another girl the afternoon of the prom. That’s when

Peter told Craig that if Craig didn’t say something to Sam, he would. Well, Craig didn’t say anything, and Peter still didn’t think it was his business, but then he overheard Sam at the party.
...
My dad said, “Was he there with his family? Did you bother the poor man?” “No. He was alone.”
...
“I was smoking a cigarette,” was his reply. “Couldn’t you wait ten minutes?” was my sister’s. “But it was a great song,” was his final word.
...
After primping, my sister followed the trail of graduation caps to the field, and we all found our way to the bleachers. I sat in between my mom and
...
My sister was second in her class, so she gave the fourth speech. The valedictorian is always last. Then, Mr. Small and the vice principal, whom Patrick swears is gay, hand out the diplomas.
...
“What has 32 legs and 1 tooth?” “What?” we all asked.
“A West Virginia unemployment line.” Things like that.
...
At about 9:30, everyone was stuffed and sober. At 9:45, the hugs were over. At 9:50, the driveway was clear. My father gave me twenty dollars and the keys to his car, saying, “Thanks for sticking around.
It meant a lot to me and the family.” He was tipsy, but meant it just the same. Sam had told me they were going to a dance club downtown. So, I loaded everyone’s gifts in my trunk, climbed in the car, and drove away.
...
Under the books was a card that I wrote using the typewriter Sam bought me. The cards said that these were my copies of all my favorite books, and I wanted Sam and Patrick to have them because they were my two favorite
...
Sam said, “You know I’m leaving in a week, Charlie?” “Yeah. I know.”
...
Peter took me into the kitchen to make coffee, so I could sober up to drive home. I had about eight cups in a row and was ready to drive in about twenty minutes. The problem was, by the time I got home, I was so awake from the coffee, I couldn’t fall asleep. By the time I got to school, I felt like dying.
Luckily, all the finals were over, and all we did all day was watch film strips. I don’t think I ever slept better. I was glad, too, because school really is lonely without them.
...
Today, pretty much every teacher just let the kids sit around and talk after we handed in our textbooks. I honestly didn’t know anybody, except maybe for Susan, but after that time in the hallway, she’s avoided me more than ever. So, I didn’t really talk. The only good class was Bill’s because I got to talk to Bill. It was hard saying good-bye to him after class was over, but he said that it wasn’t good-bye.
...
each other for the summer. And everyone was clearing out their lockers by throwing their old papers and notes and books on the hallway floor. When I got to my locker, I saw this skinny kid who had the locker next to me all year. I had never really talked to him before.
I cleared my throat and said, “Hey. My name is Charlie.” All he said was, “I know.”
Then, he closed his locker door and walked away.
So, I just opened my locker, put all my old papers and things in my backpack, and walked over the debris of books and papers and notes in the hallway to the parking lot outside. Then, I got on the bus.
...
The night before Sam was going to leave made the whole week a blur. Sam was frantic because not only did she need to spend time with us, but she had to get ready to go. Buying things. Packing things.
Things like that.
...
The best part was that Sam said she didn’t ask him about the girls he might be dating even though she wanted to know. She wasn’t bitter. She was sad,
...
So, I just watched her pack, and I tried to notice as many details as I possibly could. Her long hair and her thin wrists and her green eyes. I wanted to
...
“Why didn’t you ask me out when the whole Craig thing happened?” I just sat there. I didn’t know what to say. She said it soft.
...
“Yeah,” I said.
“Then, why didn’t you?” she asked real serious. “Because I didn’t think you wanted me to.” “Why did you think that?”

“Because of what you said.”
“What I said nine months ago? When I told you not to think of me that way?” I nodded.
...
“You know I blamed Craig for not letting me do things? You know how stupid I feel about that now?
...
She waited patiently for my answer. But after everything she said, I figured that I should just do what I wanted to do. Not think about it. Not say it out loud. And if she didn’t like it, then she could just say so.
And we could go back to packing.
So, I kissed her. And she kissed me back. And we lay down on the floor and kept kissing. And it was soft. And we made quiet noises. And kept silent. And still. We went over to the bed and lay down on all the things that weren’t put in suitcases. And we touched each other from the waist up over our clothes. And then under our clothes. And then without clothes. And it was so beautiful. She was so beautiful. She took my hand and slid it under her pants. And I touched her. And I just couldn’t believe it.
It was like everything made sense. Until she moved her hand under my pants, and she touched me.
...
I guess I nodded because she helped me get dressed. And then she put on her shirt. And I wanted to kick myself for being such a baby. Because I loved
...
I don’t know what I’m supposed to do now. I know other people have it a lot worse. I do know that, but it’s crashing in anyway, and I just can’t stop

thinking that the little kid eating french fries with his mom in the shopping mall is going to grow up and hit my sister. I’d do anything not to think that. I know I’m thinking too fast again, and it’s all in my head like the trance, but it’s there, and it won’t go away. I just keep seeing him, and he keeps hitting my sister, and he won’t stop, and I want him to stop because he doesn’t mean it, but he just doesn’t listen, and I don’t know what to do.
...
The thing that helped me the most, though, was the time I could have visitors. My family, including my brother and sister, always came for those days until my brother had to go back to school to play football.
After that, my family came without my brother, and my brother sent me cards. He even told me on his last card that he read my report on Walden and liked it a lot, which made me feel really good. Just like the first time I saw Patrick. The best thing about Patrick is that even when you’re in a hospital, he doesn’t change. He just cracks jokes to make you feel better instead of asking you questions about feeling worse. He even brought me a letter from Sam, and

Sam said that she was coming back at the end of August, and if I got better by then, she and Patrick would drive me through the tunnel. And this time, I could stand in the back of the pickup truck if I wanted to. Things like that helped more than anything.
The days when I received mail were good, too. My grandfather sent me a really nice letter. So did my great aunt. So did my grandma and Great Uncle Phil. My Aunt Rebecca even sent me flowers with a card that was signed by all my Ohio cousins. It was nice to know that they were thinking about me just like it was nice the time Patrick brought Mary Elizabeth and Alice and Bob and everyone for a visit.
Including Peter and Craig. I guess they’re friends again. And I was glad they were. Just like I was glad that Mary Elizabeth did most of the talking. Because it made things feel more normal. Mary Elizabeth even stayed a little later than the others. I was so happy to have a chance to talk with her alone before she left for Berkeley. Just like I was happy for Bill and his girlfr when they came to see me two weeks ago. They’re getting married this November, and they want me to go to their wedding. It’s nice to have things to look forward to.
...
It’s like if I blamed my aunt Helen, I would have to blame her dad for hitting her and the friend of the family that fooled around with her when she was little. And the person that fooled around with him. And God for not stopping all this and things that are much worse. And I did do that for a while, but then

I just couldn’t anymore. Because it wasn’t going anywhere. Because it wasn’t the point.
...
When I got released yesterday, my mom drove me home. It was in the afternoon, and she asked me if I was hungry. And I said yes. Then, she asked me what I wanted, and I told her I wanted to go to McDonald’s like we did when I was little and got sick and stayed home from school. So, we went there.
And it was so nice to be with my mom and eat french fries. And later that night to be with my family at dinnertime and have things just be like they always were. That was the amazing part. Things just keep going. We didn’t talk about anything heavy or light. We were just there together. And that was enough.
So, today my father went to work. And my mother took my sister and me out to take care of last-minute things for my sister since she’s leaving for college

in a few days. When we got back, I called Patrick’s house because he said that Sam should be home by then. Sam answered the phone. And it was so nice to hear her voice.
...
But mostly, I was crying because I was suddenly very aware of the fact that it was me standing up in that tunnel with the wind over my face. Not caring if I saw downtown. Not even thinking about it.
Because I was standing in the tunnel. And I was really there. And that was enough to make me feel infinite.
Tomorrow, I start my sophomore year of high school. And believe it or not, I’m really not that afraid of going. I’m not sure if I will have the time to write any more letters because I might be too busy trying to
“participate.”
So, if this does end up being my last letter, please believe that things are good with me, and even
when they’re not, they will be soon enough. And I will believe the same about you. Love always,

Charlie THE END Page 118
"""
...
patternForVerbs = [[{'POS': 'VERB', 'OP': '+'}]]
patternForParts = [[{'POS': 'PART', 'OP': '+'}],
            [{'POS': 'ADP', 'OP': '+'}],
            [{'POS': 'PRT', 'OP': '+'}]]
matcherVerbs = Matcher(nlp.vocab)
matcherParts = Matcher(nlp.vocab)
matcherVerbs.add("verb-phrases", patternForVerbs)
matcherParts.add("parts", patternForParts)

sentsWithVerbs = []
sentsWithVerbsAndParts = []

# get only sentences with verbs
for sentence in sentences:
    doc = sentence.as_doc()
    # call the matcher to find matches
    verbMatches = matcherVerbs(doc)
    if(len(verbMatches) > 0):
        sentsWithVerbs.append(sentence)

    #spans = [doc[start:end] for _, start, end in verbMatches]

for sentence in sentsWithVerbs:
    doc = sentence.as_doc()
    particlesMatch = matcherParts(doc)
    if (len(verbMatches) > 0):
        sentsWithVerbsAndParts.append(sentence)

PVs = []
potentialPVs = []
sentsWithPotentialPVs = []
sentsWithPVs = []
vCount = 0

print("{:<15} | {:<15} | {:<10} | {:<15} ".format('Token', 'POS', 'Relation', 'Head'))
for sent in sentsWithVerbsAndParts:
    for token in sent:
        if token.pos_ == "VERB":
            vCount += 1
        if token.dep_ == 'ROOT' or token.dep_ == 'pcomp' or token.dep_ == 'xcomp' or token.dep_ == 'ccomp' \
                or token.dep_ == 'relcl' or token.dep_ == 'advcl' or token.dep_ == 'acl' or token.dep_ == 'conj':
            compounds = [child for child in token.children
                         if child.dep_ == "prt" or child.dep_ == "prep"]
            print("{:<15} | {:<15} | {:<10} | {:<15} "
                  .format(str(token.text), str(token.pos_), " ", " "))
            for child in token.children:
                tok = child
                print("{:<15} | {:<15} | {:<10} | {:<15} "
                      .format(str(tok.text), str(tok.pos_), str(tok.dep_), str(tok.head)))
                if child.dep_ == "prt":
                    PVs.append(token.text + " " + child.text)
                    sentsWithPVs.append(sent)
                elif child.dep_ == "prep":
                    if abs(token.i - child.i) == 1:
                        pv = token.lemma_ + " " + child.text
                        if pv in _verbs:
                            PVs.append(token.text + " " + child.text)
                            sentsWithPVs.append(sent)
